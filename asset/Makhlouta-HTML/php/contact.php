...
if (!$fname) $errors[count($errors)] = 'Please enter first name.';
if (!$lname) $errors[count($errors)] = 'Please enter last name.';
...
if (!$errors) {
	...
	// ====== Your mail here  ====== //
	$to = 'Your Name <mymail@mail.com>';
	
	// Sender
	//$from = $name . ' <' . $email . '>';
	$from = 'Contact <contact@okathemes.com>';
